...
def graph(root_dir,pypath,config,num_steps,query):
  ...
  FLAGS.pipeline_config_path = pypath+'/PSCMR_Tensorflow_object_trainer/training/'+config 
  FLAGS.trained_checkpoint_prefix =pypath+'/PSCMR_Tensorflow_object_trainer/training/model.ckpt-'+str(num_steps)
  FLAGS.output_directory = root_dir+'/'+query+'/frozen_graph' 
